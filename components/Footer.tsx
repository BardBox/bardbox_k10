...
export default function Footer() {
  ...
  return (
    <footer id="contact" className="bg-gradient-to-br from-neutral-charcoal-dark via-neutral-charcoal to-neutral-charcoal-dark text-white">
      {/* Main Footer Content */}
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <p className="text-gray-300 mb-6 leading-relaxed">
              Your trusted partner in finding the perfect commercial property in Vadodara. Over 15 years of excellence in real estate.
            </p>
          ...
          {/* Quick Links */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-primary-gold">Quick Links</h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.label}>
                  <a
                    href={link.href}
                    className="text-gray-300 hover:text-primary-rust transition-colors flex items-center group"
                  >
          ...
          {/* Property Types */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-primary-gold">Property Types</h4>
            <ul className="space-y-3">
          ...
          {/* Contact Info */}
          <div>
            <h4 className="text-lg font-bold mb-6 text-primary-gold">Get In Touch</h4>
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <a
                  ...
                  className="group"
                >
                  <p className="text-gray-300 group-hover:text-primary-rust transition-colors">"K10 INDEX" opp. Grand Mercure Hotel,</p>
                  <p className="text-gray-300 group-hover:text-primary-rust transition-colors">Sayajigunj, Vadodara - 390005</p>
                </a>
              </li>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div className="flex flex-col space-y-1">
                  <a href="tel:+918799077477" className="text-gray-300 hover:text-primary-rust transition-colors">
                    +91 72280 95566
              ...
              <li className="flex items-center space-x-3">
                ...
                <a href="mailto:indexk10@gmail.com" className="text-gray-300 hover:text-primary-rust transition-colors">
                  indexk10@gmail.com
                </a>
              </li>
        ...
        <div className="container mx-auto px-4 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm">
              <a href="#" className="text-gray-400 hover:text-primary-rust transition-colors">
                Privacy Policy
              </a>
